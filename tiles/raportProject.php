...
<body>
    ...
    $qst = "SELECT id_projektu, nazwa_projektu FROM projekty";
    ...
    <div class="contentMain">
        ...
        <form method="post">
            <label for="projektSelect">Wybierz projekt:</label>
    ...
    if (isset($_POST['selectSubmitter'])) {
        ...
        $qst2 = "SELECT * FROM projekty WHERE id_projektu='$value'";
        ...
        if ($query2) {
            ...
            while ($row = mysqli_fetch_array($query2)) {
                ...
                echo "<tr>";
                echo "<td>" . $row['id_projektu'] . "</td><td>" .
                    $row['id_klienta'] . "</td><td>" .
                    $row['nazwa_projektu'] . "</td><td>" .
                    $row['data_rozpoczecia'] . "</td><td>" .
                    $row['data_zakonczenia'] . "</td><td>" .
                    $row['liczba_podstron'] . "</td><td>" .
                    yesNo($row["graficzny"]) . "</td><td>" .
                    yesNo($row["cms"]) . "</td><td>" .
                    yesNo($row["ekspresowy_czas_wykonania"]) . "</td>";
                echo "<tr>";
            }
            echo "</tbody></table>";
            echo '</div>';
